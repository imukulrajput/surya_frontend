      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-violet-600 rounded-lg flex items-center justify-center text-white font-black text-xl">T</div>
              <span className="font-bold text-xl text-slate-900">MyWork</span>
            </div>
            <p className="text-slate-500 text-sm leading-relaxed mb-6">
              Earn money by completing simple tasks online. Get rewarded for your time.
            </p>
            <div className="flex gap-4 text-slate-400">
              <a href="#" className="hover:text-violet-600 transition"><TwitterIcon /></a>
              <a href="#" className="hover:text-violet-600 transition"><FacebookIcon /></a>
              <a href="#" className="hover:text-violet-600 transition"><InstagramIcon /></a>
              <a href="#" className="hover:text-violet-600 transition"><LinkedInIcon /></a>
            </div>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4 text-sm text-slate-500 font-medium">
              ...
              <li><a href="#" className="hover:text-violet-600 transition">FAQ</a></li>
        ...
        <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-400 text-sm">
            &copy; 2026 MyWork. All rights reserved.
          </p>
