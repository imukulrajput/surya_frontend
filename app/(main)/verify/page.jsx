...
export default function VerifyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-10">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
        <h1 className="text-4xl font-extrabold text-slate-900 mb-2 tracking-tight">Verify Your Account</h1>
        <p className="text-slate-500 font-medium text-lg">Link your social media profile to start earning rewards.</p>
      </motion.div>
